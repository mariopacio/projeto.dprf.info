...
/**
 * DPRF.info
 * Página responsável pelo mapeamento das informações por rodovia/estado
 * 
 ...
 */
    ...
    $ObjBRUF = $infoDPRF->resultados['LOCALBR']['BR-'.$infoDPRF->BR][$infoDPRF->UF];
    $ObjBRUF_Anterior = $infoDPRF_Anterior->resultados['LOCALBR']['BR-'.$infoDPRF->BR][$infoDPRF->UF];
            ...
            <div class="row-fluid page-head">
                ...
                <div class="page-bar">
                    <ul class="nav nav-tabs pull-left">
                        ...
                        <li id="bruf-tab" class="hidden-phone"><a href="<?php echo $Url_Base; ?>BR/Procurar/<?php echo $infoDPRF->URL; ?>"><i class="aweso-icon-refresh"></i> Alterar rodovia</a></li>
                        <li id="semestre-tab" class="hidden-phone"><a href="#tperiodo" data-toggle="tab"><i class="aweso-icon-refresh"></i> Alterar período</a></li>
                    </ul>
                    <ul class="nav nav-dropdown pull-left visible-phone">
                        <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#">Mais <span class="hide-x4small">ações</span> <i class="fontello-icon-down-open"></i></a>
                            <ul class="dropdown-menu nav">
                                <li><a href="<?php echo $Url_Base; ?>BR/Procurar/<?php echo $infoDPRF->URL; ?>">Alterar rodovia</a></li>
                                ...
                                <div class="span12 well <?php echo $infoDPRF->theme['well']; ?>">
                                    <div class="row-fluid">
                                        <div class="span6 grider">
                                            <h3><i class="fontello-icon-road"></i>BR-<?php echo $infoDPRF->BR; ?>/<?php echo $infoDPRF->UF; ?> <small><?php echo $infoDPRF->Legenda_Periodo; ?></small></h3>

                                            <p class="pagedesc">O gráfico abaixo representa o comparativo de ocorrências entre os <?php echo $infoDPRF->Legenda_Abangencia; ?> nesta rodovia.</p>
                                                    ...
                                                    <div class="row-fluid">
                                                        ...
                                                        <div class="span6 grider-item">
                                                            <div class="statistic-box well <?php echo $infoDPRF->theme['well']; ?> well-impressed">
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    $Total_Atual = intval($infoDPRF->resultados['LOCALBR']['BR_UF']['BR-'.$infoDPRF->BR.'/'.$infoDPRF->UF]);
                                                                    // Total de ocorrências do periodo anterior ao pesquisado
                                                                    $Total_Anterior = intval($infoDPRF_Anterior->resultados['LOCALBR']['BR_UF']['BR-'.$infoDPRF->BR.'/'.$infoDPRF->UF]);
                                                        ...
                                                        <div class="span6 grider-item">
                                                            <div class="statistic-box well <?php echo $infoDPRF->theme['well']; ?> well-impressed">
                                                                ...
                                                                <?php 
                                                                    // Total de ocorrências do periodo pesquisado
                                                                    $TotalPessoas_Atual = $ObjBRUF['PESSOAS']['TOTAL'];
                                                                    // Total de ocorrências do periodo anterior ao pesquisado
                                                                    $TotalPessoas_Anterior = intval($ObjBRUF_Anterior['PESSOAS']['TOTAL']);
                                                                    // Porcentagem de diferença entre os dois períodos comparados
                                                    ...
                                                    <div class="row-fluid">
                                                                ...
                                                                <div class="span6 grider-item">
                                                                    <ul class="nav nav-well stats_mortes_feridos">
                                                                        ...
                                                                        <li class="Ttip" title="Números que representam um total de <?php echo number_format($ObjBRUF['ESTADO_FISICO'][2], 0, '', '.'); ?> ferimentos leves, seguidos de <?php echo number_format($ObjBRUF['ESTADO_FISICO'][3], 0, '', '.'); ?> ferimentos com maior gravidade.">
                                                                            <span class="well <?php echo $infoDPRF->theme['well']; ?> stat-yellow dblock">
                                                                                <i class="fontello-icon-lifebuoy"></i>
                                                                                <h4 class="statistic-values pull-right"><?php echo number_format($ObjBRUF['ESTADO_FISICO'][2] + $ObjBRUF['ESTADO_FISICO'][3], 0, '', '.'); ?></h4>
                                                                                Pessoas feridas
                                                                            </span>
                                                                        </li>
                                                                        ...
                                                                        <li class="Ttip" title="As mortes não são registradas em casos onde as pessoas feridas venham a falecer posteriormente.">
                                                                            <span class="well <?php echo $infoDPRF->theme['well']; ?> negative dblock">
                                                                                <i class="fontello-icon-lifebuoy"></i>
                                                                                <h4 class="statistic-values pull-right"><?php echo number_format($ObjBRUF['ESTADO_FISICO'][4], 0, '', '.'); ?></h4>
                                                                                Pessoas mortas
                                                                            </span>
                                                                        </li>
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            arsort($ObjBRUF['DIASEMANA']);
                                                                            // Buscamos todos os dias
                                                                            $contador_dia_semana = 0;
                                                                            // Legenda tooltip
                                                                            $Legenda_Dia1 = '';
                                                                            $Legenda_Dia2 = '';
                                                                            foreach($ObjBRUF['DIASEMANA'] as $diasemana => $valor){
                                                                        ...
                                                                        <li class="Ttip" title="">
                                                                            <span class="well <?php echo $infoDPRF->theme['well']; ?> dblock">
                                                                                ...
                                                                                <h4 class="statistic-values pull-right"><?php 
                                                                                    arsort($ObjBRUF['HORA']);
                                                                                    foreach($ObjBRUF['HORA'] as $horario => $valor){
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="tabbable tabbable-bordered tabs-top <?php echo $infoDPRF->theme['tabbable']; ?>">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <?php if(count($ObjBRUF['TIPO_ACIDENTE']) > 5): ?>
                                                            ...
                                                            <table class="table table-condensed">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                        ...
                                                                        arsort($ObjBRUF['TIPO_ACIDENTE']);
                                                                        //ksort($ObjBRUF['TIPO_ACIDENTE'][$infoDPRF->Tipo_Periodo]);
                                                                        
                                                                        $Periodo_Array = $infoDPRF->Tipo_Periodo;
                                                                        if($Periodo_Array == 'Diario') $Periodo_Array = 'Horario';
                                                                        
                                                                        foreach($ObjBRUF['TIPO_ACIDENTE'] as $id_tipo_acidente => $Total_Atual){
                                                                            ...
                                                                            if(is_numeric($Total_Atual)){
                                                                                ...
                                                                                $DSPLine = array();
                                                                                $sparkline = array();
                                                                                ksort($ObjBRUF['TIPO_ACIDENTE'][$Periodo_Array]);
                                                                                foreach($ObjBRUF['TIPO_ACIDENTE'][$Periodo_Array] as $mes_tipo_acidente => $tipo_acidente){
                                                                                ...
                                                                                $Total_Anterior = intval($ObjBRUF_Anterior['TIPO_ACIDENTE'][$id_tipo_acidente]);                                                                        
                                                                                // Porcentagem de diferença entre os dois períodos comparados
                                                                                $Porcentagem = $infoDPRF->Porcentagem($Total_Atual, $Total_Anterior);
                                                                                // Formata os números com milhar
                                                                                ...
                                                                                echo '
                                                                                    <tr>
                                                                                        <th><span class="">'.$infoDPRF->getTipoAcidente($id_tipo_acidente).'</span></th>
                                        ...
                                        <div class="span6 grider">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12 grider-item">
                                                    ...
                                                    <?php if($infoDPRF->resultados['LOCALBR']['BR-'.$infoDPRF->BR][$infoDPRF->UF]['LAT_LONG']): ?>
                                                    ...
                                                    <div class="row-fluid">
                                                        <div class="span12">
                                                        <?php $showMaps = true; ?>                                  
                                                        <div id="map" class="trechos br_uf" <?php if(!$infoDPRF->resultados['LOCALBR']['BR-'.$infoDPRF->BR][$infoDPRF->UF]['LAT_LONG']): ?>style="height: 300px;"<?php endif; ?>></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row-fluid top10">
                                                ...
                                                <div class="tabbable tabbable-bordered tabs-top <?php echo $infoDPRF->theme['tabbable']; ?>">
                                                    <ul class="nav nav-tabs">
                                                        ...
                                                        <?php if(count($ObjBRUF['CAUSA_ACIDENTE']) > 5): ?>
                                                        ...
                                                        <table class="table table-condensed">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    arsort($ObjBRUF['CAUSA_ACIDENTE']);
                                                                    ksort($ObjBRUF['CAUSA_ACIDENTE'][$Periodo_Array]);
                                                                    
                                                                    foreach($ObjBRUF['CAUSA_ACIDENTE'] as $id_causa_acidente => $Total_Atual){
                                                                        ...
                                                                        if(is_numeric($Total_Atual)){
                                                                            ...
                                                                            $DSPLine = array();
                                                                            foreach($ObjBRUF['CAUSA_ACIDENTE'][$Periodo_Array] as $mes_causa_acidente => $causa_acidente){
                                                                                $DSPLine[] = $causa_acidente[$id_causa_acidente];
                                                                            }
                                                                            $DSPLine = implode(',', $DSPLine);
                
                                                                            // Total desta causa de acidente no periodo anterior 
                                                                            $Total_Anterior = intval($ObjBRUF_Anterior['CAUSA_ACIDENTE'][$id_causa_acidente]);
                                                                            // Porcentagem de diferença entre os dois períodos comparados
                                                                            $Porcentagem = $infoDPRF->Porcentagem($Total_Atual, $Total_Anterior);
                                                                            // Formata os números com milhar
                                                                            $Total_Atual = number_format($Total_Atual, 0, '', '.');
                                                                            ...
                                                                            echo '
                                                                                <tr>
                                                                                    <th><span class="">'.$infoDPRF->getCausaAcidente($id_causa_acidente).'</span></th>
                                                                                    <td class="text-right bold">'.$Total_Atual.'</td>
                                                                                    <td class="hidden-phone text-right '.$class_pct.' bold"> 
                                                                                        <span class="Ttip" title="'.$legenda.'">'.$Porcentagem.'</span> 
                                                                                        <i class="indicator fontello-icon-'.$icone_pct.'-dir"></i> 
                                                    ...
                                                    <ul class="nav nav-well veiculos">
                                                        <li>
                                                            <div class="info-block f11 l14">
                                                                ...
                                                                O sexo de aproximadamente <?php echo number_format($ObjBRUF['SEXO']['ND'], 0, '', '.'); ?> condutores não foi registrado no sistema.
                                                            </div>
                                                        </li>
                                                    </ul>
