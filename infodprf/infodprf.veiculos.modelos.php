...
/**
 * DPRF.info
 * Página com os modelos de veículos mais envolvidos em ocorrências
 * 
                                ...
                                <div class="span12 well <?php echo $infoDPRF->theme['well']; ?>">
                                    <div class="row-fluid">
                                        <div class="span8 grider">
                                            ...
                                            <h3><i class="aweso-icon-tasks"></i> Modelos de veículos <small class="hidden-phone"><?php echo $infoDPRF->Legenda_Periodo; ?></small></h3>
                                            
                                            <div class="row-fluid">
                                                <div class="span12">
                                                <p class="pagedesc">Confira a lista dos <?php echo $Limit_Modelos; ?> modelos mais envolvidos em ocorrências no <?php echo $infoDPRF->Legenda_Periodo_Display; ?>.</p>
